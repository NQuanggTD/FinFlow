    ...
    <>
      ...
      <div className="p-5 border-b border-indigo-800/60 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center text-lg"><span>💰</span></div>
          <div>
            <h1 className="text-base font-bold leading-none">FinFlow</h1>
            <p className="text-indigo-400 text-[11px] mt-0.5">Tài chính thông minh</p>
          </div>
        </div>
      ...
      <div className="p-4 border-t border-indigo-800/60">
        <p className="text-indigo-500 text-[11px] text-center">FinFlow v1.0.0 · CTK46-PM</p>
      </div>
    </>
  );
}
...
export function Sidebar() {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className="hidden md:flex w-60 bg-indigo-900 text-white flex-col flex-shrink-0">
        <SidebarContent />
      </aside>
